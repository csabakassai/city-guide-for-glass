...
<%@ page import="com.doctusoft.cityguide.MainServlet" %>
...
<!doctype html>
<%
	String userId = com.doctusoft.cityguide.AuthUtil.getUserId(request);
  String appBaseUrl = WebUtil.buildUrl(request, "/");

  Credential credential = com.doctusoft.cityguide.AuthUtil.getCredential(userId);
